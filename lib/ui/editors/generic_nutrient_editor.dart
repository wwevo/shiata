    ...
    try {
      if (widget.entryId != null) {
        await repo.update(widget.entryId!, {
          ...
          'payload_json': jsonEncode({'amount': amount, 'unit': widget.kind.unit}),
        ...
        await repo.create(
          ...
          payload: {'amount': amount, 'unit': widget.kind.unit},
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            validator: (v) {
                              ...
                              if (val < widget.kind.minValue || val > widget.kind.maxValue) {
                                return 'Must be ${widget.kind.minValue}–${widget.kind.maxValue}';
                              }
                              return null;
                            },
                          ),
                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                ...
                                final next = (val + 1).clamp(widget.kind.minValue, widget.kind.maxValue);
